      ...
      <div className="navbar bg-gradient-to-b from-base-300 to-transparent lg:absolute lg:top-0 lg:z-50">
        <div className="navbar-start">
          ...
          <div className="flex items-center">
            <Image src="/icon-512x512.png" alt="logo" width="80" height="80" />
            <a
              href="/"
              className={`${nightTokyo.className} btn btn-ghost font-extrabold text-3xl  bg-clip-text bg-gradient-to-r from-gray-200 to-gray-600 tracking-widest`}
            >
              KANASHIMI
            </a>
          </div>
