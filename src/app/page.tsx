    ...
    <div>
      ...
      <div className="xl:flex justify-between">
        <div className="lg:m-10 mt-10 flex flex-col items-center justify-center lg:items-start lg:justify-start">
          <p className="text-xl mb-10 uppercase font-bold text-gray-50 tracking-widest">
            Recent Release
          </p>

          <div className="flex flex-wrap justify-between lg:justify-start xl:gap-8 lg:gap-6 gap-3 m-2 lg:m-0 text-gray-50">
          ...
          <ContinueWatching />
          <p
            className={`text-xl mt-20 lg:mt-30 mb-10 uppercase font-bold text-gray-50 tracking-widest`}
          >
            Popular Release
          </p>
        ...
        <div className="lg:m-10 mt-10 flex flex-col items-center justify-center lg:items-start lg:justify-start xl:w-2/3">
          <h2 className="text-xl mb-10 uppercase font-bold text-gray-50 tracking-widest">
            Recent News
          </h2>
